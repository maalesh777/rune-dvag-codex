    ...
    <div className="flex justify-center items-center py-12 animate-fade-in-up">
      <Card className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 mt-2">Bitte authentifizieren Sie sich, um fortzufahren.</p>
        </div>
        <div className="flex flex-col items-center space-y-6">
          <Button onClick={login} variant="secondary" className="w-full flex items-center justify-center gap-3 !py-4">
            <GoogleIcon />
